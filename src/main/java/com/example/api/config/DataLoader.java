    ...
    CommandLineRunner initDatabase(
        ...
        return args -> {
            ...
            if (productosRepo.count() == 0) {
                productosRepo.save(new Productos(null, "Foundation - Tabla Star y Moon",
                ...
                productosRepo.save(new Productos(null, "Foundation - Skate Completo",
                ...
                productosRepo.save(new Productos(null, "Creature - Camisa Manga Larga Reversible.",
                ...
                productosRepo.save(new Productos(null, "Slimeball - Ruedas OG Classic 99A",
                ...
                productosRepo.save(new Productos(null, "Slimeball - Ruedas OG White 101A",
                ...
                productosRepo.save(new Productos(null, "Santa Cruz - Poleron Roskopp Dissect",
                        "Poleron Santa Cruz Roskopp Dissect Hoodie Cement.",
                        "https://wallride.cl/cdn/shop/files/44252766_157221_80288_Roskopp_Dissect_Pullover_Hoodie_Santa_Cruz_Mens_Shirt_color_cement_360x.webp?v=1762874999",
                        29990.0, 2, "Ropa"));

                productosRepo.save(new Productos(null, "PILL - Tabla Completa Stay Free 1",
                ...
                productosRepo.save(new Productos(null, "RIPNDIP - Poleron Lord Nermal",
